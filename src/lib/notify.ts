...
//   - all leads / admins
//
// FOLLOW-UP (VPS bot): the 1-hour "no reaction -> DM the person" escalation
// lives in agent/. This dispatcher returns the group message_id so that loop
// can correlate reactions/replies; persisting the pending-escalation row is
// scaffolded in supabase/migrations and wired bot-side in a later pass.
