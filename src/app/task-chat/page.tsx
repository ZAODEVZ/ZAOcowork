      ...
      <div className="relative max-w-4xl mx-auto py-6 space-y-4">
        ...
        <div className="rounded-2xl bg-white/[0.04] backdrop-blur-xl border border-white/10 p-4 md:p-5">
          <div className="mb-4 flex items-center gap-2">
            ...
            <span className="text-sm font-semibold text-white/80">Task Chat</span>
            <span className="text-xs text-white/40">— conversational task management with actionable buttons</span>
          </div>
          <TaskChat />
        </div>
        ...
        <footer className="pt-4 text-xs text-white/30 border-t border-white/10 flex items-center justify-between">
          ...
          <span>chat suggests actions as buttons — confirm by tapping, not auto-executed</span>
        </footer>
      </div>
      <SlaGridChip />
    </main>
