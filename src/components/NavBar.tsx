...
function NavMenu({
  ...
  showAdmin: boolean;
  active: { mine: boolean; calendar: boolean; activity: boolean; chat: boolean; admin: boolean; settings: boolean };
}) {
  ...
  const anyActive =
    active.mine || active.calendar || active.activity || active.chat || active.admin || active.settings;
