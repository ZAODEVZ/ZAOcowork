...
// /api/v1/auto-close: hit by the GitHub Actions poll with Bearer auth (AUTOCLOSE_KEY), no session.
const PUBLIC_PREFIXES = ["/login", "/api/login", "/api/github/webhook", "/api/digest", "/shipped", "/api/v1/auto-close"];
